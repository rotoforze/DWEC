...
function init() {
    ...
    formReview.addEventListener('submit', (e) => {
        ...
        if (!error) {
            ...
            document.querySelector(`[data-artistaid="${modal.getAttribute("data-artistaid")}"], [data-escenarioid="${modal.getAttribute("data-escenarioid")}"],  [data-dia="${modal.getAttribute("data-dia")}"]`).querySelector(".btn-review")
        }
    })
