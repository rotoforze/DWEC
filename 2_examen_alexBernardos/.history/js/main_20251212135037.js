...
function init() {
    ...
    formReview.addEventListener('submit', (e) => {
        ...
        if (!error) {
            ...
            console.log(document.querySelector(`.plan-item-actions, [data-artistaid="${modal.getAttribute("data-artistaid")}"], [data-escenarioid="${modal.getAttribute("data-escenarioid")}"], [data-dia="${modal.getAttribute("data-dia")}"]`))
            document.querySelector(`.plan-item-info [data-artistaid="${modal.getAttribute("data-artistaid")}"] [data-escenarioid="${modal.getAttribute("data-escenarioid")}"]  [data-dia="${modal.getAttribute("data-dia")}"]`).querySelector(".btn-review").disabled;
        }
    })
