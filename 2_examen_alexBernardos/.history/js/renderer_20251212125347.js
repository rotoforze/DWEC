...
function addPlan(horario) {
    if (!planes.has(horario)) {
        ...
        document.querySelectorAll(".btn-review").forEach((btn) => {
            ...
            const horario = getHorario(padreConDatos.getAttribute("data-artistaid"),
            ...
            btn.addEventListener('click', () => {
                ...
                modal.setAttribute()
                modal.querySelector("h3").textContent = `Dejar una reseña para ${getArtista(horario.artistaId).nombre}`;
