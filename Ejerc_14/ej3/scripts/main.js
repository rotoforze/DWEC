...
function setCookie() {
    ...
    document.cookie = "bienvenida=" + new Date() + ";" + expires + ";path=/";
}
...
function checkCookie() {
    ...
    if (cookie != "") {
        ...
        banner.innerHTML = `<p>Bienvendio de nuevo! Última visita: ${cookie}</p><button id="cerrarBanner">X</button>`;
        document.querySelector('#cerrarBanner').addEventListener('click', () => {
            banner.hidden = true;
        })
        banner.hidden = false;
    } else {
